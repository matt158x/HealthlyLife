...
@Composable
fun RecipeDetailScreen(navController: NavController, imageId: Int) {

    val recipes = mapOf(
        R.drawable.granolafruits1 to Recipe(
            "Granola Fruits",
        ...
        R.drawable.breakfastburrito2 to Recipe(
            "Breakfast Burrito",
        ...
        R.drawable.greensmoothie3 to Recipe(
            "Green Smoothie",
        ...
        R.drawable.vietnamchicken4 to Recipe(
            "Vietnamese Chicken",
        ...
        R.drawable.pancakes6 to Recipe(
            "Pancakes",
        ...
        R.drawable.airfryerpotato7 to Recipe(
            "Air Fryer Potato",
